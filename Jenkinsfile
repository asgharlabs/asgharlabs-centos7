pipeline {
    ...
    stages {
        ...
        stage('\u27A1 Master-Inflate variables.json') {
            ...
            steps {
                sh 'cp /home/admini/centos7/variables.json $WORKSPACE/centos7/variables.json'
            }
        }
        stage('\u27A1 Inflate variables.json') {
            ...
            steps {
                sh 'cp /home/admini/centos7/notmaster-variables.json $WORKSPACE/centos7/notmaster-variables.json'
            }
        }
        stage('\u27A1 Master-Build image with packer') {
            ...
            steps {
                sh '$WORKSPACE/packer build -var-file=$WORKSPACE/centos7/variables.json $WORKSPACE/centos7/centos7.json'
            }
        }
        stage('\u27A1 Build image with packer') {
            ...
            steps {
                sh '$WORKSPACE/packer build -var-file=$WORKSPACE/centos7/notmaster-variables.json $WORKSPACE/centos7/centos7.json'
            }
        }
